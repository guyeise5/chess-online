    ...
    <header className={styles['header']}>
      <div className={styles['headerLeft']}>
        ...
        <nav className={styles['nav']}>
          <Link to="/" className={`${styles['navLink']} ${inActiveGame ? styles['navLinkDisabled'] : ""} ${location.pathname === "/" || isActive("/game") ? styles['navLinkActive'] : ""}`} onClick={inActiveGame ? (e) => e.preventDefault() : undefined}>
          ...
          <Link to="/computer" className={`${styles['navLink']} ${inActiveGame ? styles['navLinkDisabled'] : ""} ${isActive("/computer") || isActive("/play/computer") ? styles['navLinkActive'] : ""}`} onClick={inActiveGame ? (e) => e.preventDefault() : undefined}>
          ...
          <Link to="/puzzles" className={`${styles['navLink']} ${inActiveGame ? styles['navLinkDisabled'] : ""} ${isActive("/puzzles") ? styles['navLinkActive'] : ""}`} onClick={inActiveGame ? (e) => e.preventDefault() : undefined}>
          ...
          {showGameHistory && (
            <Link to="/games" className={`${styles['navLink']} ${inActiveGame ? styles['navLinkDisabled'] : ""} ${isActive("/games") ? styles['navLinkActive'] : ""}`} onClick={inActiveGame ? (e) => e.preventDefault() : undefined}>
      ...
      <div className={styles['headerRight']}>
        {showBoardSettings && onOpenSettings && (
          <button className={styles['settingsLink']} onClick={onOpenSettings} title="Board settings">
